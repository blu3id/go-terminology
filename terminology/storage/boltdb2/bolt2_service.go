...
// It implements the `storage.Store` Interface
...
// Returns `storage.Store` interface
func New(filename string, readOnly bool) (storage.Store, error) {
...
func (bs *bolt2Service) GetStatistics() (storage.Statistics, error) {
